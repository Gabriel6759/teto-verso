...
function closeCart() {
    ...
    cartWindow.classList.add('closing');

    // Espera o tempo da animação (0.4s) antes de esconder o overlay
    setTimeout(() => {
        cartOverlay.style.display = 'none';
        cartWindow.classList.remove('closing');
    }, 400);
}
...
function clearCart() {
    ...
    closeCart(); // Fecha o carrinho após limpar para melhorar a UX
}
